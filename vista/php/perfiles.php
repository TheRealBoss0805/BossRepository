...
<html>
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" href="vista/css/perfiles.css">
        <title>Ejemplo para la próxima página Web</title>
    </head>
    <body>
        <div class="container">
            <div class="icon">
                ...
                data-id="content1">
                    <img src="vista/imagenes/usuarios/img1.jpg">
                </div>
                <div class="imgBx" style="--i:2;"
                data-id="content2">
                    <img src="vista/imagenes/usuarios/img2.jpg">
                </div>
                <div class="imgBx" style="--i:3;"
                data-id="content3">
                    <img src="vista/imagenes/usuarios/img3.jpg">
                </div>
                <div class="imgBx" style="--i:4;"
                data-id="content4">
                    <img src="vista/imagenes/usuarios/img4.jpg">
                </div>
                <div class="imgBx" style="--i:5;"
                data-id="content5">
                    <img src="vista/imagenes/usuarios/img5.jpg">
                </div>
                <div class="imgBx" style="--i:6;"
                data-id="content6">
                    <img src="vista/imagenes/usuarios/img6.jpg">
                </div>
                <div class="imgBx" style="--i:7;"
                data-id="content7">
                    <img src="vista/imagenes/usuarios/img7.jpg">
                </div>
                <div class="imgBx" style="--i:8;"
                data-id="content8">
                    <img src="vista/imagenes/usuarios/img8.jpg">
                </div>
            </div>
            <div class="content">
    ...
    <script src="vista/js/perfiles.js"></script>
</html>
